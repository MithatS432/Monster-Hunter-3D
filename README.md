# Monster-Hunter-3D
Kill all the creatures and escape from this cursed place

# What I really want to do
Adjusting the movement parts with Seek algorithm and Pursuit algorithms
...
# Game Explanation
We're trying to defeat 15 different versions of the same creature in a village. They all have different speeds, damage, and routes

# Controls
w,a,s,d or arrow keys to movement
"space" key to jump
Mouse1 to attack
"F" key to apply super power
